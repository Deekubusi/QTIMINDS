    ...
    <main className="min-h-screen bg-[#f7f8fb] px-4 py-8">
      <div className="max-w-[1280px] mx-auto">
        ...
        <header className="mb-6">
          ...
          >
            Hamsa PG, TNGO Colony, Gachibowli, Hyderabad, 25 rooms with 50
            beds, Owner: Mohan-923456781
          </div>
        </header>
        ...
        <section className="mb-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <article className="bg-white border border-[#4F6BE3] rounded-lg p-4 flex flex-col shadow-sm">
              ...
              <div className="flex-1 flex flex-col items-center justify-start">
                ...
                <div className="mt-4 text-center">
                  <div className="font-semibold" style={{ fontSize: "clamp(0.9rem,1.6vw,1.05rem)" }}>
                    44/53 beds occupied
                  </div>
                  <div className="mt-2 flex items-center justify-center gap-2" style={{ fontSize: "clamp(0.78rem, 1.4vw, 0.95rem)" }}>
              ...
              <div className="mt-4 text-right">
                <button className="text-[#0F45A9] font-medium" style={{ fontSize: "clamp(0.78rem, 1.4vw, 0.95rem)" }}>
                  View Details →
                </button>
              </div>
            </article>
              ...
              <div className="flex-1 flex flex-col items-center">
                ...
                <div className="w-full max-w-[340px]">
                  <svg viewBox="0 0 270 210" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
                    <g fontFamily="Nunito" fontSize="11" fill="#000" textAnchor="end">
                    ...
                    {/* bars */}
                    <rect x="70" y={158 - (25 / 80) * 110} width="16" height={(25 / 80) * 110} fill="#4F6BE3" rx="2" />
                    <rect x="95" y={158 - (20 / 80) * 110} width="16" height={(20 / 80) * 110} fill="#FFD66B" rx="2" />

                    <rect x="135" y={158 - (50 / 80) * 110} width="16" height={(50 / 80) * 110} fill="#4F6BE3" rx="2" />
                    <rect x="160" y={158 - (35 / 80) * 110} width="16" height={(35 / 80) * 110} fill="#FFD66B" rx="2" />

                    <rect x="200" y={158 - (75 / 80) * 110} width="16" height={(75 / 80) * 110} fill="#4F6BE3" rx="2" />
                    <rect x="225" y={158 - (55 / 80) * 110} width="16" height={(55 / 80) * 110} fill="#FFD66B" rx="2" />

                    {/* values above bars */}
                    <g fontFamily="Nunito" fontSize="11" fill="#000" textAnchor="middle">
                      <text x="78" y={158 - (25 / 80) * 110 - 6}>25</text>
                      <text x="103" y={158 - (20 / 80) * 110 - 6}>20</text>
                      <text x="143" y={158 - (50 / 80) * 110 - 6}>50</text>
                      <text x="168" y={158 - (35 / 80) * 110 - 6}>35</text>
                      <text x="208" y={158 - (75 / 80) * 110 - 6}>75</text>
                      <text x="233" y={158 - (55 / 80) * 110 - 6}>55</text>
                    </g>
                ...
                <div className="flex gap-6 mt-3 items-center justify-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>Capacity</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-3.5 h-3.5 block bg-[#FFD66B]" />
                    <span style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>Active Guests</span>
                  </div>
                </div>

                <div className="mt-3 flex items-center gap-2" style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>
                  <svg viewBox="0 0 10 14" className="w-3 h-3"><path d="M0 5H4V13.92L6.01 13.95V5H10L5 0L0 5Z" fill="#10BA2A"/></svg>
            ...
            <article className="bg-white border border-[#4F6BE3] rounded-lg p-4 flex flex-col shadow-sm">
              ...
              <div className="text-center mt-1" style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>
                INR in K
              </div>
                  ...
                  <div className="flex items-start">
                    <div className="w-1/3">
                      <div className="flex flex-col justify-between h-[110px]">
                        ...
                        <div className="text-[0.95rem] font-medium">Expense</div>
                        <div className="text-[0.95rem] font-medium">Revenue</div>
                      </div>
                    </div>
                    ...
                    <div className="w-2/3 pl-4">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="w-12 text-right text-[0.95rem] font-medium">200</div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="w-12 text-right text-[0.95rem] font-medium">300</div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="w-12 text-right text-[0.95rem] font-medium">500</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-4 flex items-center justify-center gap-2" style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>
                <svg viewBox="0 0 11 15" className="w-3 h-3"><path d="M10.1371 8.94884L6.13761 9.01061L5.99985 0.0916788L3.98963 0.0927244L4.12785 9.04166L0.138328 9.10328L5.21495 14.0255L10.1371 8.94884Z" fill="#D11A2A"/></svg>
                <div><span className="font-semibold text-[#D11A2A] mr-1">8%</span> vs last month</div>
              </div>
              ...
              <header className="flex items-center justify-center gap-3 mb-2">
                <div className="w-7 h-7" aria-hidden>
                  <svg viewBox="0 0 30 30" className="w-full h-full">
                    <path d="M16.0825 3.74994L27.99 24.3749C28.0997 24.565 28.1575 24.7805 28.1575 24.9999C28.1575 25.2194 28.0997 25.4349 27.99 25.6249C27.8803 25.815 27.7225 25.9728 27.5325 26.0825C27.3425 26.1922 27.1269 26.2499 26.9075 26.2499H3.0925C2.87308 26.2499 2.65753 26.1922 2.46751 26.0825C2.27749 25.9728 2.1197 25.815 2.00999 25.6249C1.90028 25.4349 1.84253 25.2194 1.84253 24.9999C1.84253 24.7805 1.90029 24.565 2.01 24.3749L13.9175 3.74994C14.0272 3.55994 14.185 3.40215 14.375 3.29245C14.565 3.18275 14.7806 3.125 15 3.125C15.2194 3.125 15.435 3.18275 15.625 3.29245C15.815 3.40215 15.9728 3.55994 16.0825 3.74994ZM13.75 19.9999V22.4999H16.25V19.9999H13.75ZM13.75 11.2499V17.4999H16.25V11.2499H13.75Z" fill="black"/>
                  </svg>
                </div>
                <h3 className="font-semibold" style={{ fontSize: "clamp(0.95rem, 1.8vw, 1.25rem)" }}>Overdue</h3>
              </header>
              ...
              <div className="flex-1 flex flex-col items-center">
                ...
                <div className="mt-4 flex flex-col items-start gap-2 w-full px-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>&lt; 15 Days - 55%</div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3.5 h-3.5 rounded-sm bg-[#FF8F6B]" />
                    <div style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>15-30 Days - 25%</div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3.5 h-3.5 rounded-sm bg-[#FFD66B]" />
                    <div style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>&gt; 30 Days - 20%</div>
                  </div>
                </div>
              </div>

              <div className="mt-4 text-center" style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>
                <svg viewBox="0 0 11 15" className="inline-block w-3 h-3 mr-2"><path d="M10.1371 8.94884L6.13761 9.01061L5.99985 0.0916788L3.98963 0.0927244L4.12785 9.04166L0.138328 9.10328L5.21495 14.0255L10.1371 8.94884Z" fill="#D11A2A"/></svg>
        ...
        <section className="mb-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {["Add Manager", "Download Report", "Send Announcement", "Add new PG"].map((label, idx) => (
              <button
                key={idx}
        ...
        {/* Check-In/Out header + buttons */}
        <section className="mb-6">
          <div className="flex justify-end mb-3">
            <div className="inline-flex rounded-lg overflow-hidden shadow-sm">
              <button className="px-3 py-2 bg-[#4F6BE3] text-white font-semibold" style={{ fontSize: "clamp(0.78rem,1.6vw,0.95rem)" }}>Calendar</button>
              <button className="px-3 py-2 bg-white border border-black text-black font-semibold -ml-px" style={{ fontSize: "clamp(0.78rem,1.6vw,0.95rem)" }}>List</button>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col sm:flex-row gap-3 items-center">
              <div className="flex-1 min-w-0 bg-[#EFF6FF] border border-[#052A88] rounded-lg h-[50px] flex items-center justify-center px-3">
                <span className="font-bold" style={{ fontSize: "clamp(0.95rem,1.6vw,1.25rem)" }}>Upcoming Check-In</span>
              </div>
              <button className="w-full sm:w-auto bg-[#4F6BE3] text-white rounded-lg h-10 px-4" style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-center">
              <div className="flex-1 min-w-0 bg-[#EFF6FF] border border-[#052A88] rounded-lg h-[50px] flex items-center justify-center px-3">
                <span className="font-bold" style={{ fontSize: "clamp(0.95rem,1.6vw,1.25rem)" }}>Upcoming Check-Out</span>
              </div>
              <button className="w-full sm:w-auto bg-[#4F6BE3] text-white rounded-lg h-10 px-4" style={{ fontSize: "clamp(0.78rem,1.4vw,0.95rem)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white border rounded-lg overflow-hidden">
              <div className="overflow-x-auto">
                <table className="min-w-full table-fixed text-left">
                  ...
                  <thead className="bg-black/10">
                    <tr className="h-16">
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Guest Name</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Room/Bed</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Check-in Date</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Payment Status</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Notes</th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={idx} className="border-b">
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[0]}</td>
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[1]}</td>
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[2]}</td>
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>
                          <span className={`${row[3].includes("Paid") ? "text-green-600" : row[3].includes("Partial") ? "text-yellow-500" : "text-red-500"} font-bold`}>
                            {row[3].split(" ")[0]}
                          </span>
                          <span className="ml-2">{row[3].split(" ").slice(1).join(" ")}</span>
                        </td>
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[4]}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="px-4 py-3 text-right">
                <button className="text-[#0F45A9] font-medium" style={{ fontSize: "clamp(0.72rem,1.2vw,0.95rem)" }}>View Details →</button>
              </div>
            </div>
                ...
                <table className="min-w-full table-fixed text-left">
                  ...
                  <thead className="bg-black/10">
                    <tr className="h-16">
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Guest Name</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Room/Bed</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Check-out Date</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Due Amount</th>
                      <th className="px-4" style={{ fontSize: "clamp(0.72rem,1.4vw,0.95rem)", fontWeight: 800 }}>Feedback Given</th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={idx} className="border-b">
                        ...
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[1]}</td>
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[2]}</td>
                        <td className="px-4 py-6" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[3]}</td>
                        <td className="px-4 py-6 font-bold" style={{ fontSize: "clamp(0.7rem,1.2vw,0.95rem)" }}>{row[4]}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
