    ...
    <div className="min-h-screen bg-[#E7EFF7] px-4 py-8 lg:px-12 lg:py-14">
      <div className="max-w-[1280px] mx-auto space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[455px_minmax(520px,1fr)] grid-cols-1 items-stretch">
          {/* Key Summary Metrics */}
          <div
            className="bg-white rounded-2xl p-4 md:p-6 shadow-[8px_8px_8px_0px_rgba(0,0,0,0.25)] border-[0.7px] border-gray-200 hover:border-[#FF8F6B] transition-colors flex flex-col h-full"
            role="region"
          ...
          <div
            className="bg-white rounded-2xl p-4 md:p-6 shadow-[8px_8px_8px_0px_rgba(0,0,0,0.25)] border-[0.7px] border-gray-200 hover:border-[#FF8F6B] transition-colors flex flex-col gap-4 h-full"
            role="region"
        ...
        <div
          className="bg-white rounded-2xl p-4 md:p-6 shadow-[8px_8px_8px_0px_rgba(0,0,0,0.25)] border-[0.7px] border-gray-200 hover:border-[#FF8F6B] transition-colors flex flex-col gap-4"
          role="region"
