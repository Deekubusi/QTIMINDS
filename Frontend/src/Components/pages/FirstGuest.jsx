// FirstGuest.jsx
// import { useNavigate } from "react-router-dom"; // Removed as it's not used in this component

// Card 1: Room Details
function RoomDetailsCard() {
  // const navigate = useNavigate(); // Removed as it's not used in this component
  return (
    <div
      aria-label="Room Details"
      // --- MODIFIED: Changed hover border to thinner (border-2) and kept original color ---
...
export default function FirstGuest() {
  // This is the full address used for the Google Maps query.
  // If this data comes from props or state, you can make these variables.
  const pgName = "Hamsa PG,";
  const pgAddress = "Hamsa PG, TNGO Colony, Gachibowli, Hyderabad";
  
  // This creates the URL-safe query string
  const mapQuery = encodeURIComponent(pgAddress);
